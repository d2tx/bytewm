/* st gruvbox dark theme for bytewm */
...
static const char *colorname[] = {
	...
	"#cc241d",  /* red     (bright)   */
	"#98971a",  /* green   (bright)   */
	"#d79921",  /* yellow  (bright)   */
	"#458588",  /* blue    (bright)   */
	"#b16286",  /* magenta (bright)   */
	"#689d6a",  /* cyan    (bright)   */
	"#a89984",  /* white   (gray)     */
	...
	"#689d6a",  /* 258 = cursor color      */
	"#8ec07c",  /* 259 = reverse cursor    */
};
